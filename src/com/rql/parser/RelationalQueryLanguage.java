...
import com.rql.symbolTable.Attribute;
import com.rql.symbolTable.Reference;
import com.rql.symbolTable.SymbolTable;
import com.rql.symbolTable.UnexistentForeignKeyException;
...
public class RelationalQueryLanguage implements RelationalQueryLanguageConstants {
	...
	/**
	 * Attribute used to check if there is or there is not abstract output of
	 * syntax analysis.
	 */
	private static boolean debug_sa = false; // debug lexical syntax analysis
												// process
	...
	public static void main(String args[]) throws ParseException {
		...
		/**
		 * For clause used to get the parameters that will be used in compiler
		 * process.
		 */
		for (int i = 0; i < args.length && parametersErrors == 0; i++) { // for
																			// 1
			 ...
			 */
				...
				i = checkParameterOfAttributesDefinition(args, i);
				if (i == 0) {
					helpText();
					System.exit(0);
				}
			 ...
			 */
				...
				if (i + 1 < args.length && checkParameterOfTargetSQL(args[i + 1]))
					i++;

				else {

					System.out.print(
							"The value of output-name parameter is invalid. It's just possible to use the SQL92 option.");
					parametersErrors++;
				}
			}
			/*
		...
		if (parametersErrors != 0) {
			...
			try {
				...
				default:
					System.out.printf("%c[1m%i%c[0m lexical errors were found.\u005cn", 27,
							parser.token_source.foundLexError(), 27);
				}
	...
	private static void helpText() {
		...
		System.out.printf("%c[1m", 27);
		System.out.println(String.format("\u005cn\u005ct\u00b7   %-30s", "-t, --target-sql <sql-type>",
				"Target sql type (default: SQL92)"));
		System.out.printf("%c[0m", 27);
	...
	/**
	 * Method used to check if the parameter value of --attributes-definition,
	 * 
	 * @param location
	...
	public static boolean checkParameter(String parameter) {
		...
		if (!parameter.equals("-p") && !parameter.equals("--output-path") && !parameter.equals("-n")
				&& !parameter.equals("--output-name") && !parameter.equals("-t") && !parameter.equals("--target-sql")
				&& !parameter.equals("-l") && !parameter.equals("--debug-lexical-analysis") && !parameter.equals("-s")
				&& !parameter.equals("--debug-syntax-analysis") && !parameter.equals("-h")
				&& !parameter.equals("--help")
	...
	private static void jj_la1_init_0() {
		jj_la1_0 = new int[] { 0x200, 0x0, 0x0, 0x200, 0x2000, 0x2000, 0x0, 0x0, 0x1f80000, 0x0, 0x5000, 0x5000,
				0x10880, 0x10880, 0x0, 0x200, 0x0, 0x1f80000, 0x0, 0x0, };
	}

	private static void jj_la1_init_1() {
		jj_la1_1 = new int[] { 0x38, 0x38, 0x38, 0x38, 0x0, 0x0, 0x7000, 0x2, 0x0, 0x1, 0x0, 0x0, 0x4, 0x4, 0x8000,
				0xfe000000, 0x7000, 0x0, 0xfe000000, 0x1ff0000, };
	}

	private static void jj_la1_init_2() {
		jj_la1_2 = new int[] { 0x2, 0x0, 0x0, 0x2, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x3, 0x0, 0x0,
				0x1, 0x2, };
	}
